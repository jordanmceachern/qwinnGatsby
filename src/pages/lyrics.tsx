...
const Lyrics = ({ location }) => (
  <PageLayout currentPathname={location.pathname}>
    <div className='lyrics flex flex-col grow self-center w-full lg:w-[940px] max-w-[940px] sm:mx-4 overflow-y-scroll text-black dark:text-white bg-white dark:bg-slate/50'>
      <ViewMoreLess index={0} title='Welcome to My Life'>
        ...
        <p className='mb-1'>Have a hold on me</p>
        <p className='mb-1'>(Now I say)</p>
        <p>Welcome to my life</p>
        <p>This is who I am</p>
        <p>If I’m not what you like</p>
        <p className='mb-1'>I don’t give a damn</p>
        ...
        <p className='mb-1'>You can guess where I’ve been now</p>
        <p>Welcome to my life</p>
        <p>This is who I am</p>
        <p>If I’m not what you like</p>
        <p className='mb-1'>I don’t give a damn</p>
      ...
      <ViewMoreLess index={1} title='Already Gone'>
        ...
        <p className='mb-1'>I give all I am to you, I give a lot</p>
        <p>I’m already gone</p>
        <p>Rushing to arrive</p>
        <p className='mb-1'>But I’m already gone</p>
        ...
        <p className='mb-1'>You slip away</p>
        <p>Rushing to arrive but you’re already gone</p>
      ...
      <ViewMoreLess index={3} title='Doc Martens'>
        ...
        <p className='mb-1'>Jk jk but you made me shop, thanks a lot</p>
        ...
        <p className='mb-1'>I’m a big bad tough bitch</p>
        ...
        <p className='mb-1'>Ask me how I do it, I’ll admit</p>
        <p>My doc martens</p>
        ...
        <p className='mb-1'>I could take you over if you wanted</p>
        <p>I’ve become who I always was</p>
        <p>What I tried to hide</p>
        <p>Now I’m showing off</p>
      </ViewMoreLess>

      <ViewMoreLess index={4} title='YLTWIL'>
        ...
        <p className='mb-1'>You love the way I leave</p>
        <p>I could be yours but you don’t want it</p>
        <p className='mb-1'>Come on you know that it’s true, admit</p>
      ...
      <ViewMoreLess index={5} title='Congratulations'>
        ...
        <p className='mb-1'>I'm gonna be cautious</p>
        ...
        <p className='mb-1'>A delicate process</p>
        ...
        <p className='mb-1'>But you don’t care as long as you are the star</p>
        <p>Congratulations</p>
        <p>Congratulations</p>
        ...
        <p className='mb-1'>Winning when you were the only nomination</p>
        ...
        <p className='mb-1'>You don’t even try to</p>
      ...
      <ViewMoreLess index={6} title='Edit My Love'>
        <p>I am myself</p>
        ...
        <p className='mb-1'>But there they are again</p>
        <p className='mb-1'>Oh I guess I let them in</p>
      ...
      <ViewMoreLess index={7} title='Puddles'>
